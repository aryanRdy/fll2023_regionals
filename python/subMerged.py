...
async def speedyRun_1():
    ...
    await straight(Direction.FORWARD, 880, 500)
    await turn(Direction.LEFT, 60, 500)

    # ram into the artificial habitat
    await straight(Direction.BACKWARD, 180, 700)
    ...
    await straight(Direction.FORWARD, 130, 500)
    ...
    await straight(Direction.BACKWARD, 150, 900)
    ...
    await straight(Direction.FORWARD, 660, 700, justGoFast=1)
...
async def Run_2_backup():
    ...
    await straight(Direction.FORWARD, 340, 600, justGoFast=1)

    # move more left getting parallel to sonar discovery
    await turn(Direction.LEFT, 50, 750)
    ...
    await straight(Direction.FORWARD, 720, 600, justGoFast=1)
    await turn(Direction.LEFT, 20, 800)
...
async def Run_2():
    ...
    # =======#
    await straight(Direction.BACKWARD, 280, 900)
...
async def Run_5_2():
    ...
    await straight(Direction.BACKWARD, 1200, 1000, accel=1000)
    await turn(Direction.RIGHT, 0, 400, 45)  # turn to facing the whale mission
    # moving towards the whale mission
    await straight(Direction.BACKWARD, 400, 400)
    # Feed the WHALE
    await attachmentMotor_async(Arm.RIGHT, 950, 500, Direction.UP)
