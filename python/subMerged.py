...
async def run_3():
    ...
    await turn(Direction.LEFT, 135, 100)
    # end of kracken

    # move towards trident mission
    await straight(500, 1070, Direction.FORWARD)
    await turn(Direction.LEFT, 45, 100)
